...
```
cast_model_type: Casts your model's parameter and buffers to the desired type.

path_torch_functions: Patch all Torch functions and Tensor methods to perform Tensor Core-friendly ops like GEMMs and Convolutions in FP16, and any ops that benefit from FP32 precision in FP32.
